  ...
  <main id="main" class="main">
    ...
    <div class="row">
      <div class="col-md-12 mb-3">
        <a href="check_stock.jsp"><button class="btn btn-secondary float-end"><i class="fa fa-backward" aria-hidden="true"></i>&ensp;Back</button></a>
      </div>
    </div>
            ...
            <div class="card-body mt-5">
              ...
              <table class="table table-striped my-2 display " id="example">
               ...
               <tbody>
									...
									String q = "select all_assets.*,new_assigning.Name from all_assets inner join new_assigning on all_assets.Product_ID=new_assigning.Keyboard_Id where all_assets.Status='Assigned'";
									...
									rs = st.executeQuery("select *  from all_assets where Status=\"New\" and Category='Keyboard'");
									while (rs.next()) {
									%>
									<tr>
										<td><%=a%></td>
									...
									rs = st.executeQuery("select *  from all_assets where Status=\"Faulty\" and Category='Keyboard'");
									while (rs.next()) {
									%>
									<tr class="">
										<td><%=a%></td>
