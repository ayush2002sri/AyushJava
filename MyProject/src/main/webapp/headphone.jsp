  ...
  <aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
        <i class="fa fa-book" aria-hidden="true"></i><span>Issued Products</span><i class="bi bi-chevron-down ms-auto"></i>
      </a>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
      	<ol class="breadcrumb"><li class="breadcrumb-item"><a href="">
							Stock</a></li>
          <li class="breadcrumb-item"><a href="check_stock.jsp">Check Stock</a></li>
    ...
    <div class="row">
      <div class="col-md-12 mb-3">
        <a href="check_stock.jsp"><button class="btn btn-secondary float-end"><i class="fa fa-backward"
              aria-hidden="true"></i>&ensp;Back</button></a>
      </div>
    </div>
            ...
            <div class="card-body mt-5">
              ...
              <table class="table table-striped my-2 display" id="example">
                ...
                <tbody>
									...
									String q = "select all_assets.*,new_assigning.Name from all_assets inner join new_assigning on all_assets.Product_ID=new_assigning.AdditionalProduct_Id where all_assets.Status='Assigned' and Additional_Product='Headphone'";
									...
									rs = st.executeQuery("select *  from all_assets where Status=\"New\" and Category='Headphone'");
									while (rs.next()) {
									%>
									<tr>
										<td><%=a%></td>
									...
									rs = st.executeQuery("select *  from all_assets where Status=\"Faulty\" and Category='Headphone'");
									while (rs.next()) {
									%>
									<tr class="">
										<td><%=a%></td>
