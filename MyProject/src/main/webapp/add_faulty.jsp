...
<title>Add Faulty Products</title>
...
<div>
	...
	<aside id="sidebar" class="sidebar">
		...
		<li class="nav-item"><a class="nav-link collapsed"
			...
			<ul id="tables-nav12" class="nav-content collapse show "
				data-bs-parent="#sidebar-nav">
				<li><a href="add_faulty.jsp" class="active"> <i class="bi bi-circle"></i><span>Add
							to Faulty </span>
				</a></li>
	...
	<main id="main" class="main">
		...
		<div class="pagetitle">
			...
			<nav>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item ">Faulty Products</li>
					<li class="breadcrumb-item active">Add to Faulty</li>
				</ol>
			</nav>
		</div>
		<!-- End Page Title -->
		<div class="col-lg-12">
			<div class="card">
				<div class="card-body">
					<h5 class="card-title">Add Product to Faulty</h5>
					<!-- Vertical Form -->
					<form class="row g-3" method="post" action="faulty" onsubmit="confirmation_faulty()">
						<div class="col-6">
							<label for="inputNanme4" class="form-label">Product ID</label> 
							<input
								type="text" class="form-control" id="inputNanme4" name="prod_id" required="required" onkeyup="validate_addFaulty(this.value)">
						  <div id="info" class="text-danger pt-1 fw-bold"></div>
						</div>
						<div class="col-6">
							<label for="inputEmail4" class="form-label">Category</label> <select
								name="prod_category" id="" class="form-control" required="required">
						...
						<div class="col-12">
							<label for="problem" class="form-label">Problem</label>
							 <input
								type="text" class="form-control" id="problem" name="problem" required="required">
						</div>
