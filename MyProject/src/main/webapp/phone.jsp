						...
						<div class="card-body mt-5">
							...
							<table class="table table-striped my-2  display" id="example">
								...
								<tbody>
									...
									String q = "select all_assets.*,new_assigning.Name from all_assets inner join new_assigning on all_assets.Product_ID=new_assigning.AdditionalProduct_Id where all_assets.Status='Assigned' and Additional_Product='Mobile Phone'";
									...
									rs = st.executeQuery("select *  from all_assets where Status=\"New\" and Category='Mobile Phone'");
									while (rs.next()) {
									%>
									<tr>
										<td><%=a%></td>
									...
									rs = st.executeQuery("select *  from all_assets where Status=\"Faulty\" and Category='Mobile Phone'");
									while (rs.next()) {
									%>
									<tr class="">
										<td><%=a%></td>
