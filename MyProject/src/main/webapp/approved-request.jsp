    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav1" data-bs-toggle="collapse" href="#">
          <i class="fa fa-cubes" aria-hidden="true"></i></i><span>Stock</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="new_assigning.jsp">
              <i class="bi bi-circle"></i><span>New Assiging</span>
            </a>
          </li>
        </ul>
      </li><!-- End Tables Nav -->
	<li class="nav-item"><a class="nav-link collapsed"
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="approved-request.jsp" class="active">
              ...
              <table class="table table-striped my-2  display" id="example">
                <thead>
              	...
              	<tbody>
									...
									String q = "select * from request where Status='Approved'";
