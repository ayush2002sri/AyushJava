    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Scrap Material</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <table class="table table-striped my-2  display" id="example">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Delete from Scrap</th>
                ...
                <tbody>
									...
									String q = "select * from scrap_material";
									...
									<tr>
										...
										<td><%=rs.getString(2)%></td>
										  <td><a href=""><button type="button"
													class="btn btn-light">Delete</button></a></td>
